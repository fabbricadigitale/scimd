...
var mongoTests = []mongoCase{
	...
	},
	{
		...
		//bson.M{"$and": []interface{}{bson.M{"_": bson.M{"$eq": "Employee"}}, bson.M{"$and": []interface{}{bson.M{"_": bson.M{"$eq": "work"}}, bson.M{"_": bson.M{"$regex": bson.RegEx{Pattern: "@example\\.com", Options: "i"}}}}}}, "meta.resourceType": "User"},
